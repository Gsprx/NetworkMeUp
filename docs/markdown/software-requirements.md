...
\[*Ένας πίνακας με τους επιχειρησιακούς κανόνες. Βλέπε πίνακα 3-4 του παραδείγματος 3-1 στη σελίδας 133 του βιβλίου.*\]

| Επιχειρησιακοί κανόνες | Περιγραφή |
| :----------------------| :---------|
| ΕΚ1 | Η ονομασία και το ΑΦΜ είναι μοναδικά για κάθε εταιρεία.
| ΕΚ2 | Όλα τα απαιτούμενα στοιχεία είναι υποχρεωτικά.
| ΕΚ3 | Η ηλικία του χρήστη θα πρέπει να είναι μεγαλύτερη των 18 ετών.
| ΕΚ4 | Ένας ενδιαφερόμενος μπορεί να υποβάλλει το πολύ μία αίτηση σε κάθε ανοιχτή θέση εργασίας.
| ΕΚ5 | Μη επιτρεπτές ενέργειες και η παραβίαση της πολητικής της εφαρμογής από κάποιον λογαριασμό θα συνοδεύεται από την άμεση διαγραφή του.