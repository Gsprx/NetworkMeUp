...
2. Το σύστημα ζητάει από τον εργοδότη να δώσει email, κωδικό πρόσβασης και ΑΦΜ. 
3. Ο εργοδότης δίνει email, κωδικό πρόσβασης και ΑΦΜ.
...
6. Το σύστημα εμφανίζει τις επιλογές για την αλλαγή των στοιχείων του λογαριασμού (email, αριθμό τηλεφώνου, κωδικό πρόσβασης, ΑΦΜ).
