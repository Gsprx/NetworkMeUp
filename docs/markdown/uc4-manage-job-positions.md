...
4. Το σύστημα ζητάει από τον εργοδότη να συμπληρώσει μια περιγραφή της θέσης, τις απαιτήσεις της θέσης όσον αφορά την ελάχιστη αποδεκτή παιδεία και τομέα καθώς και γνώση γλωσσών (οι οποίες χρησιμοποιούνται για το πρώτο επίπεδο φιλτραρίσματος των αιτήσεων), τον σχετικό μισθό και προαιρετικά οτιδήποτε τυχών έξτρα προνόμιο (bonuses) παρέχεται από την εταιρία.
