...
public class EmployeeApplicationRecyclerViewAdapter extends RecyclerView.Adapter<EmployeeApplicationRecyclerViewAdapter.ApplicationViewHolder>{
    ...
    public EmployeeApplicationRecyclerViewAdapter.ApplicationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new EmployeeApplicationRecyclerViewAdapter.ApplicationViewHolder(view);
        }
    ...
    public void onBindViewHolder(@NonNull EmployeeApplicationRecyclerViewAdapter.ApplicationViewHolder holder, int position) {
