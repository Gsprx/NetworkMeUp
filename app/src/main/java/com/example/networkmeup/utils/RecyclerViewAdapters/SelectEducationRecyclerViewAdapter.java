...
public class SelectEducationRecyclerViewAdapter extends RecyclerView.Adapter<SelectEducationRecyclerViewAdapter.SelectEducationViewHolder> {
    private ArrayList<Education> educations;
    private Context context;
    private ItemClickListener clickListener;

    public SelectEducationRecyclerViewAdapter(Context context, ArrayList<Education> educations){
    ...
    public SelectEducationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SelectEducationViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull SelectEducationViewHolder holder, int position) {
    ...
    public class SelectEducationViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public SelectEducationViewHolder(@NonNull View itemView) {
            super(itemView);
